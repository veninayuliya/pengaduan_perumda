  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Lain-lain</h3>
                </div>
                <form method="post">
      ...
      if($_SERVER['REQUEST_METHOD'] == "POST"){
        ...
        if($pencarian != ""){
          $sql = "SELECT pengaduan.id_pengaduan, pelanggan.id_pelanggan, pelanggan.nama, pengaduan.no_wa, pelanggan.alamat, pengaduan.jenis_pengaduan, pengaduan.isi_pengaduan, pengaduan.status FROM pengaduan INNER JOIN pelanggan ON pengaduan.id_pelanggan = pelanggan.id_pelanggan WHERE pengaduan.jenis_pengaduan = 'Lain-lain' AND 
              pengaduan.id_pengaduan LIKE '%$pencarian'";
          $query = $sql;
          $queryJml = $sql;

        } else {
          $query = "SELECT pengaduan.id_pengaduan, pelanggan.id_pelanggan, pelanggan.nama, pengaduan.no_wa, pelanggan.alamat, pengaduan.jenis_pengaduan, pengaduan.isi_pengaduan, pengaduan.status FROM pengaduan INNER JOIN pelanggan ON pengaduan.id_pelanggan = pelanggan.id_pelanggan WHERE pengaduan.jenis_pengaduan = 'Lain-lain' AND LIMIT $posisi, $batas";
          $queryJml = "SELECT * FROM pengaduan";
          $no = $posisi * 1;
        }
      }
      else{
        $query = "SELECT pengaduan.id_pengaduan, pelanggan.id_pelanggan, pelanggan.nama, pengaduan.no_wa, pelanggan.alamat, pengaduan.jenis_pengaduan, pengaduan.isi_pengaduan, pengaduan.status FROM pengaduan INNER JOIN pelanggan ON pengaduan.id_pelanggan = pelanggan.id_pelanggan  WHERE pengaduan.jenis_pengaduan = 'Lain-lain' LIMIT $posisi, $batas";
        $queryJml = "SELECT * FROM pengaduan";
        $no = $posisi * 1;
      }
